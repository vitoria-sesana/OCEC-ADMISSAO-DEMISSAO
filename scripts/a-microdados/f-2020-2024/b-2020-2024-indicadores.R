# rotina ------------------------------------------------------------------
source("scripts/a-microdados/f-2020-2024/0-rotina-2020-2024.R", encoding = "UTF-8")
...
tab <- left_join(tab, qnt_2019_2023, by = c("ano", "setor_criativo"))
tab <- copy(tab)
...
ggplot(tab, aes(x = mes_ano,
  ...
  # scale_y_continuous(breaks = seq(0.5,1.5,0.1), limits = c(0, 1.5)) + 
